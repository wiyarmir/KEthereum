...
const val PUBLIC_KEY_STRING =
    "0x506bc1dc099358e5137292f4efdd57e400f29ba5132aa5d12b18dac1c1f6aab" + "a645c0b7b58158babbfa6c6cd5a48aa7340a8749176b120e8516216787a13dc76"
...
val TEST_MESSAGE = "A test message".encodeToByteArray()
...
val TEST_BIGINTEGERS_POSITIVE_ONLY = listOf(
    ...
    ONE,
    TEN,
    BigInteger.fromLong(42),
    BigInteger.fromLong(420),
...
fun getABIString(name: String): String {
    return Resource("/$name.abi").readText()
}
